...
//         for (size_t i = 0; i < BLOCK_SIZE; i ++) {
//           for (size_t j = 0; j < BLOCK_SIZE; j ++) {
//             __m256 a = _mm256_set1_ps(local_a[i][j]);
//             for (size_t k = 0; k < BLOCK_SIZE; k += SIMD_SIZE) {
//               __m256 b = _mm256_load_ps(&local_b[i][k]);
//               __m256 c = _mm256_load_ps(&local_c[j][k]);
//               c = _mm256_fmadd_ps(a, b, c);
//               _mm256_store_ps(&local_c[j][k], c);
//             }
//           }
//         }
//       }
